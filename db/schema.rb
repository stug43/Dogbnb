...
ActiveRecord::Schema.define(version: 2019_01_31_184341) do
  ...
  create_table "stroll_dog_lists", force: :cascade do |t|
    t.integer "dog_id"
    t.integer "stroll_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dog_id"], name: "index_stroll_dog_lists_on_dog_id"
    t.index ["stroll_id"], name: "index_stroll_dog_lists_on_stroll_id"
  end

  create_table "strolls", force: :cascade do |t|
    t.integer "city_id"
    t.integer "stroll_dog_list_id"
    ...
    t.index ["stroll_dog_list_id"], name: "index_strolls_on_stroll_dog_list_id"
  end
